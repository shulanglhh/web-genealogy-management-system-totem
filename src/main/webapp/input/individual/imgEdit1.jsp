	...
	<div style="float: right; width: 50%;">
		...
		<form  method="post" id='individual-photo-form' enctype="multipart/form-data">
			...
			<table>
				...
				<tr><td><input type="hidden" name="uid" id="personid" /><button type="submit">上传</button><button type="reset">重置</button></td></tr>
			</table>  		
			</div>	
		</form>	
	</div>
...
jQuery(function($){
	//var boundx,boundy;
	//boundx = $("#img-edit").width();
	//boundy = $("#img-edit").height();
	$("#img-edit").Jcrop({
		boxWidth:400,
		boxHeight:0,
