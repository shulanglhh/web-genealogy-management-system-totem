 ...
 <div data-options="region:'north'" style="height:50px;overflow:hidden;">
    ...
    <div data-options="region:'center',title:'隐藏管理'" style="padding:5px;background:#eee;">
    	<div class="easyui-layout" data-options="fit:true">
    		<div data-options="region:'west',title:'选择族谱',split:false" style="width:200px">
    			<table width='100%'>
    				<tr><td>
    				<select name="rname" id="rname">
				    </select>
				    </td></tr>
				    <tr><td width='30'>起始世代&nbsp;&nbsp;&nbsp;<input type="text" name="start" id="str" size="2" /></td></tr>
    				<tr><td width='30'>结束世代&nbsp;&nbsp;&nbsp;<input type="text" name="end" id="end" size="2" /></td></tr>
    ...
    $(document).ready(function(){
    	...
    	$("#confirm").click(function(){
    		...
    		var end=$("#end").val();
    	     $("#cc").datagrid({
    	    	    method:'post',
    	        	url: '${pageContext.request.contextPath}/tPhotoAction!showped.action?pid='+pid+'&start='+str+'&end='+end,
    	       		singleSelect:true,
    	       		toolbar:'#tb',
    	       		onClickRow:onClick,
    	       		pagination:true,
